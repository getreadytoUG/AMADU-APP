...
export default class App extends Component {
  ...
  handleBackButton = () => {
    if (this.state.canGoBack) {
      if (this.state.url === "https://web-amadu-iad5e2alq1winnk.sel4.cloudtype.app/html/login.html") {
        close();
      } else {
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <WebView
          style={{ flex: 1 }}
          source={{ uri: 'https://web-amadu-front-lxfwnt5855f2efd1.sel5.cloudtype.app/html/login.html' }}
          ref={this.webview}
          useWebKit={true}
